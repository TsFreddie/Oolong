...
declare global {
    ...
    type UnityScrollView = Element<CS.TSF.Oolong.UI.OolongScrollView>;
    type UnityInput = Element<CS.TSF.Oolong.UI.OolongInputField>;
    type UnitySlider = Element<CS.TSF.Oolong.UI.OolongSlider>;
