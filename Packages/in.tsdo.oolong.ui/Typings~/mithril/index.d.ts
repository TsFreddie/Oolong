...
declare function render(el: UnityElement, vnodes: Mithril.Children): void;
...
declare function mount(element: UnityElement, component: null): void; // tslint:disable-line unified-signatures
...
declare namespace Mithril {
    ...
    interface Hyperscript {
        /** Creates a virtual element (Vnode). */ <Attrs, State>(
        ...
        fragment(
            attrs: CommonAttributes<any, any> & {
                [key: string]: any;
            },
    ...
    interface Route {
        ...
        (element: UnityElement, defaultRoute: string, routes: RouteDefs): void;
