...
class OolongManager {
    ...
    public attach(behaviour: CS.TSF.Oolong.ScriptBehaviour, scriptClass: ScriptBehaviourType, jsonData: string) {
...
globalExtension.ScriptBehaviour = ScriptBehaviour;
globalExtension.Oolong = new OolongManager();

globalExtension.Inspect = (target: ScriptBehaviour, propertyKey: string) => {
