...
#pragma warning disable 0219
    public static class TSF_Oolong_UGUI_OolongButton_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {

                {
                    ...
                    {
                        var result = new TSF.Oolong.UGUI.OolongButton();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TSF.Oolong.UGUI.OolongButton), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_OnCreate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TSF.Oolong.UGUI.OolongButton;
