...
#pragma warning disable 0219
    public static class TSF_Oolong_UGUI_IOolongLoader_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(TSF.Oolong.UGUI.IOolongLoader).GetFriendlyName() + " constructor");
            } catch (Exception e) {
    ...
    // ==================== methods start ====================
        ...
        internal static void M_AddListener(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TSF.Oolong.UGUI.IOolongLoader;
