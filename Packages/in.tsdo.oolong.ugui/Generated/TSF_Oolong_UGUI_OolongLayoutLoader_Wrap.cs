...
#pragma warning disable 0219
    public static class TSF_Oolong_UGUI_OolongLayoutLoader_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new TSF.Oolong.UGUI.OolongLayoutLoader(arg0);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TSF.Oolong.UGUI.OolongLayoutLoader), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetAttribute(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TSF.Oolong.UGUI.OolongLayoutLoader;
