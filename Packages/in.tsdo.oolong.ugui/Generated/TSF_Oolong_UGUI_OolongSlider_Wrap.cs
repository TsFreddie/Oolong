...
#pragma warning disable 0219
    public static class TSF_Oolong_UGUI_OolongSlider_Wrap 
    {
        ...
        internal static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {

                {
                    ...
                    {
                        var result = new TSF.Oolong.UGUI.OolongSlider();


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TSF.Oolong.UGUI.OolongSlider), result);
                    }
                }
