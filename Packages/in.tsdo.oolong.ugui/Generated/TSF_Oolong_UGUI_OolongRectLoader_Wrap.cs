...
#pragma warning disable 0219
    public static class TSF_Oolong_UGUI_OolongRectLoader_Wrap 
    {
            ...
            try
            {

                {
...

                    {
                        ...
                        var result = new TSF.Oolong.UGUI.OolongRectLoader(arg0);


                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TSF.Oolong.UGUI.OolongRectLoader), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void M_SetAttribute(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TSF.Oolong.UGUI.OolongRectLoader;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void M_SetIgnoreLayout(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TSF.Oolong.UGUI.OolongRectLoader;
